...
public class SampleGamePanel extends JPanel implements ActionListener, KeyListener
{
    ...
    public void paintComponent(Graphics g)
    {
     ...
     // sets background to image
     	BufferedImage bg = ImageIO.read(getClass().getResource("EasyBackground.jpg"));
    ...
    public void playMusic()
    {
        try
        {
        	BufferedInputStream myStream = new BufferedInputStream(getClass().getResourceAsStream("HardLevelMusic.wav")); 
        	AudioInputStream audio2 = AudioSystem.getAudioInputStream(myStream);
            //sets up new file from specified path
            //File file = new File("HardLevelMusic.wav");
